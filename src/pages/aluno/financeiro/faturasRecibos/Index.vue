        ...
        >
          <template v-slot:top>
            <div class="row q-gutter-sm">
              ...
              <q-select borderless v-model="rowPerPage" :options="rowPerPageOptions" style="width: 135px"/>
            ...
            <div class="row q-gutter-sm">
              ...
              <q-btn color="primary" icon="add" to="/aluno/aproveitamento/create"/>
          ...
          <template v-slot:body-cell-opcoes="props">
            <q-td :props="props">
              <q-fab color="primary" icon="settings" direction="right" padding="sm">
                <q-fab-action color="negative" icon="delete" external-label label-position="bottom" label="Cancelar" @click="remove(props)"/>
              </q-fab>
            </q-td>
          </template>
